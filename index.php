...
<body>
    <nav class="navbar navbar-expand-lg  fixed-top" style="background-color: #b2dafa;" >
    <div class="container-fluid " style="font-size: 20px;">
        ...
        <ul class="navbar-nav" >
            ...
            <li class="nav-item">
            <a class="nav-link" href="#ficha">Minha ficha</a>
            </li>
            <li class="nav-item">
    ...
    <div id="inicio" class="pt-5 "  >
      <img  src="./img/slider1.png" class="" alt="">
    </div>

    <div id="ficha" class="vh-100 pt-4" style="background-color: rgb(219, 227, 249);">
                ...
                <div class="modal-body text-center p-5">
                    <div id="ficha" class=" pt-4" style="background-color: rgb(219, 227, 249);">
                        ...
                        <form method="post" action="#" data-parsley-validate>
                            <div class="row mb-2">
                                <div class="p-2">
                                    <h3>Edite apenas suas informações</h3>
                                </div>
                                <div class="col">
                                <div data-mdb-input-init class="form-outline">
